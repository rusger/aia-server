...
echo "📋 Next Steps:"
echo ""
echo "1️⃣  Setup Caddy reverse proxy (first time only):"
echo "    ./setup_caddy.sh"
echo ""
echo "2️⃣  Copy systemd service file:"
echo "    sudo cp astrolog-api.service /etc/systemd/system/"
echo "    sudo systemctl daemon-reload"
echo ""
echo "3️⃣  Restart the service:"
...
echo ""
echo "🔒 Security:"
echo "    • API runs on port 8080 (non-privileged)"
