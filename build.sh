...
go build -o astrolog_api astrolog_api.go crisis.go chatgpt_stream.go engagement_insights.go push.go events.go fcm.go appearance.go screentime.go languages.go renewals.go google.go referral.go identity.go expiry_sync.go finance.go seo.go seo_i18n.go
